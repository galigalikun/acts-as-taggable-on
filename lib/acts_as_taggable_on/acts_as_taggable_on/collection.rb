  ...
  module Collection
    ...
    module ClassMethods
      ...
      def all_tag_counts(options = {})
        ...
        ## Generate scope:
        tagging_scope = ActsAsTaggableOn::Tagging.select("#{ActsAsTaggableOn::Tagging.table_name}.tag_id AS tag_id, COUNT(#{ActsAsTaggableOn::Tagging.table_name}.tag_id) AS tags_count")
